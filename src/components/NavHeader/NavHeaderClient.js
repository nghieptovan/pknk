...
export default class NavHeaderClient extends Component {
    ...
    render() {
        let dropzoneRef;
        const { title, isShowedCreateChallenge, isShowedSelectChallenge, listChallenges, currentChallenge, showSearch, isShowImportInstagram } = this.props;
        return (
            <nav className="navbar navbar-default navbar-static-top m-b-0">
                <div className="headernav navbar-header">
                    ...
                    <ul className="nav navbar-top-links navbar-right pull-right">                       
                        ...
                        {isShowImportInstagram &&
                            <li className="title-client instagram" onClick={this.props.openModal}>
