...
export default class MyUploadsBody extends Component {
    constructor(props){
      ...
      renderItemSlider = (slideItem, data) => {        
        let imageUri;
        imageUri = slideItem.type && slideItem.type.includes('video') ? slideItem.thumbnail : slideItem.contentUri;     
        ...
        return (
            <div key={slideItem.id+slideItem.name} className="img-content">
                ...
                <div className="mash-item">
                    {slideItem.type && slideItem.type.includes('video') && <div className="video-icon">
