          ...
          new Promise((resolve, reject) => {
            ...
            xhr.onload = () => {
              ...
              if(result.status.code == 200){       
                ...
                this.setState({ uploadStatus: false, loadingUpload: false, valueChallenges: null, tags:[], hashtagsArray: [] });
                this.tokenExpire();
              } else {
    ...
    const {hashtagsArray, tags, valueHashtag} = this.state;    
      if (e.key === 'Enter') {        
          if(valueHashtag.trim().length == 0){
            this.setState({errorTag: 'Tag can not be empty.', valueHashtag: ''});
          }else{
          ...
          {this.state.uploadStatus && <form>
                  ...
                  <div className="hashtag">
                    <div className="react-tagsinput">
                      <span>                        
                        ...
                        <input type="text" maxLength="20" value={this.state.valueHashtag} onChange={this.updateInputValue} onKeyPress={(e) => this._handleKeyPress(e)} placeholder="Select hashtags or add your own" />
                      </span>
                    </div>                     
                  </div>                    
              ...
              <div className="row" style={{height: '60px', marginTop: '10px'}}>
                <div className="inputrow col-md-12 col-lg-12 col-sm-12 col-xs-12">
                  ...
                  <span>I agree to EnTribe's <Link to={`/terms`} target="_blank">Terms & Conditions</Link></span>
                  </div>                    
