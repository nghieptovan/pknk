...
const selector = formValueSelector('subjectAndFrom');
@connect(
    state => ({
      client: state.client,
      fields: selector(state, 'from', 'subject')
    }),
    ({
...
export default class CreatorsBody extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    nextErrorListCreator ? this.setState({error: nextErrorListCreator}):'';
    if(!this.checkExpire()){
...
exportRewardee = () => {
  ...
  flagsChanged2 = (newFlags) => {
    ...
    checkCondition = data => {
        ...
        if(!data.from){
            this.setState({errorSend: 'Template from email address '+ msg},  returnData = false);        
        } else if( !emailPattern.test(data.from)){
            this.setState({errorSend: 'Invalid email address'},  returnData = false);        
        }
         else if(!data.subject){           
            this.setState({errorSend: 'Template subject ' +msg }, returnData = false);                  
        }  
        else if( data.listAddress.length === 0 ){           
            this.setState({errorSend: 'List Creators should not be empty.'}, returnData = false);                  
        }
        else if(data.content.length === 0){           
            this.setState({errorSend: 'Content should not be empty.' }, returnData = false);                  
        }else {
            this.setState({errorSend: ''});
        }                
        return returnData;
    }
    selectAll = (type) => {
    ...
    handleCreators = () => {
        ...
        //   this.setState({loadingUpload: true});
        // }
        this.setState({ creatorList: this.state.originalCreator, loadingUpload: false});
    }
  render() {
    const { client } = this.props;   
    ...
    return (
        ...
        <div id="page-wrapper">
            <Tabs>
                <TabList>
                <Tab onClick={this.handleCreators}>Creators</Tab>
                <Tab>Mail</Tab>
                </TabList>
                ...
                <TabPanel>
                    <div className="creators-page" >
                        <div className="container-fluid" >
                            <Scrollbars style={{ height: window.innerHeight - 112 }} renderThumbVertical={({ style, ...props }) =>
                                ...
                                <div className="content-page left-page" style={{ height: window.innerHeight - 144 + 'px'}}>
                                    <div className="block-list-creator">                                        
                                        ...
                                        <div className="row list-creator">
                                            ...
                                            <Scrollbars style={{ height: window.innerHeight - 239 }} renderThumbVertical={({ style, ...props }) =>
                                            <div {...props} style={{ ...style, backgroundColor: '#fff', overflowX: 'hidden', right: '-2px' }}/>
                                            }>  
                ...
                <div className="creator-client">
                    ...
                    <div className="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                        <div className="message-block">                       
                            ...
                            <div className="body-message" style={{ height: window.innerHeight - 184 + 'px'}}>
                                <form>
                                    <div className="setting-message from">                                        
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div className="creator-block" style={{ height: window.innerHeight - 124 + 'px'}}>
                            ...
                            <Scrollbars style={{ height: window.innerHeight - 254 }} renderThumbVertical={({ style, ...props }) =>
                            <div {...props} style={{ ...style, backgroundColor: '#fff', overflowX: 'hidden', right: '-2px' }}/>
                            }>
            ...
            <Modal
                ...
                <div className="container-fluid">
                        ...
                        <div className="add-remove-list">
                            <span onClick={() => this.addToSelect()} className="add-list" style={{top: 0
                            }}>
                                <i className="icon-arrow-right"></i>
                            </span>
                            <span onClick={() => this.addToUnSelect()} className="add-list" style={{bottom: 0}}>
