...
export default class ChallengesList extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextChallenge.editChallengeStatus !== challenge.editChallengeStatus && nextChallenge.editChallengeStatus === 2) {
            if (nextChallenge.editedChallenge) {
                ...
                if ( this.state.clickLive ){
                    this.setState({currentChallenge: nextChallenge.editedChallenge});
        ...
        this.props.form.createChallenge && this.props.form.createChallenge.syncErrors && this.props.form.createChallenge.syncErrors.socialPost ? this.setState({requiredSocial: ''}) :'';
    }
    ...
    onDrop = (files, type) => {
        ...
        if(fileType === 'image'){
            this.setState({ error: '', defaultImage:'' });
            let reader = new FileReader(); 
            const EXIF = require('exif-js');        
            let css = {width: '60px', height: '60px'};   
    ...
    renderTop6Image = (data) => {
        let imageUri;
        imageUri = data.type && data.type.includes('video') ? data.thumbnail : data.contentUri;
        ...
        return (
            <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6" key={data.id}>
                <div className="image-top-6" onClick={() => this.openPreviewUpload(data)}>
                    {data.type.includes('video') && <div className="video-icon">
    ...
    clicktoView = ( id ) => {
        ...
        history.push(`/client/${shortName}/challenges/${id}`);
    }
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 counting">
                        <div className="action-area">
                            {typeChallenge === 'SAVED' &&
                                <div>
                                    <button className="btn btn-view" onClick={() => this.clicktoView(challenge.id)}>Challenge Details</button>
    ...
    closeModalPreview = () => {
        ...
        let embeddedCode = this.state.currentChallenge ? `<iframe src='${domain}${"/widget/"+this.state.currentChallenge .id}'></iframe>`:'';
        ...
        return (
            <div>
                ...
                {!this.props.loadingUpload && 
                 <Scrollbars style={{ height: window.innerHeight - 118 - checkWidth }} renderThumbVertical={({ style, ...props }) =>
                            ...
                            <div className={this.state.currentStep === 1 ? 'showStep' : 'hiddenStep'}>
                                ...
                                <div className="row" style={{ height: '130px' }}>
                                    ...
                                    <div className="inputrow col-md-6 col-lg-6 col-sm-6 col-xs-6">
                                        ...
                                        <div className="row">
                                            {this.state.defaultImage && <div><img style={this.state.css} src={this.state.defaultImage} /></div>}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className={this.state.currentStep === 2 ? 'showStep' : 'hiddenStep'}>
                                ...
                                <div className="row">
                                    <div className="inputrow col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        ...
                                        {type === 'edit' ? <TagsInput value={this.state.tags} inputValue={this.state.tag} onChangeInput={this.onChangeInput} onChange={this.handleChange} inputProps={{placeholder: "Add your own hashtags here"}} /> :
                                        <TagsInput value={this.state.tags} inputValue={this.state.tag} onChangeInput={this.onChangeInput} onChange={this.handleChange} inputProps={{placeholder: "Add your own hashtags here"}} disabled/>
                                        }                     
                                        </div>
                ...
                <form>
                    <div className="row social-share-row">
                        <div className="inputrow col-md-6 col-lg-6 col-sm-12 col-xs-12 nopadding50 leftEmbedded" style={{ height: '135px', top: '30px', marginTop: '40px' }}>
                            ...
                            />
                            <p className="text-danger">{this.props.form.createChallenge && this.props.form.createChallenge.syncErrors && this.props.form.createChallenge.syncErrors.socialPost ? '' :this.state.requiredSocial}</p>
                        </div>
