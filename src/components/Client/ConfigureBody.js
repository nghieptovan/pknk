...
export default class ConfigureBody extends Component {
    ...
    handleSave = (e)=>{
        e.preventDefault();
        const { clientId, token } = getCurrentUser();
        const data = { title: this.props.fields.title.trim(), description: this.props.fields.description.trim(), clientId}
        ...
        <div id="page-wrapper">        
            <div className="configure-client">
                ...
                <div className="body-config" style={{ height: 'auto'}}>   
                    ...
                    <div>
                        {!this.state.loadingUpload && 'No template available.'}
                    </div>
                    }                        
                    </div>                                          
                    <div className="create-email">
                        ...
                        <form>
                            <div className="template-content-wrapper">
                                ...
                                <div className="row error" style={{color: '#e25a2a', marginTop:'35px',whiteSpace:'nowrap'}}>                               
                                    {this.state.error}                               
                                </div>
                            </div>
                        </form>
            ...
            <div className="container-fluid">
                <ConfigureEditor currentMail={this.state.currentMail} titleMail={this.state.titleMail} id ={this.state.id} typeMail={this.state.typeMail} contentMail={this.state.contentMail} closeModal={this.closeModal} />
            </div>
        </Modal>   
        <Modal
