...
export default class Accounts extends Component {
  ...
  searchClient = (input) => {
    ...
    if(input.length > 0){
      ...
      let name = result.filter(data => data.challengeName ? data.challengeName.toLowerCase().includes(input.toLowerCase()):'');
      ...
      let searchList = _.union(transactionAmount,name, transactionDetail, transactionComment, balance, usableBudget, transactionDate);
