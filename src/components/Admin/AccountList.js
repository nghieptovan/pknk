        ...
        <div className="row">
            <div className="col-lg-4 col-md-4 col-sm-4 no-padding">
                ...
                <div className="col-lg-7 col-md-7 col-sm-7 outer">
                    <div className="inner overload-text">{data.challengeId &&(data.transactionDetail.includes('created') || data.transactionDetail.includes('archived')) ? data.challengeName + data.transactionDetail : data.transactionDetail}</div>
                </div>
            </div>
            {
            ...
            <div className="col-lg-6 col-md-6 col-sm-6 no-padding">               
                ...
                <div className="col-lg-6 col-md-6 col-sm-6 outer comment">
                    <div className="inner overload-text">{data.challengeId && data.transactionComment && data.transactionComment.includes('Budget allocated') ? data.transactionComment+data.challengeName: data.transactionComment}</div>
                </div>
            </div>
        </div>
    </div>
