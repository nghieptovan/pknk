...
closeModal = () => {
  ...
  render(){     
    ...
    return (  
      <div id="page-wrapper">
        <Scrollbars autoHide style={{ height: window.innerHeight - 30, overflowX:'hidden' }} renderThumbVertical={({ style, ...props }) =>
              ...
              <div className="content-rewards" style={{ height: window.innerHeight - 70 + 'px'}}>
                ...
                <div className="table-responsive">
                                <table className="table table-reward">
                                    ...
                                    <tbody style={{height: window.innerHeight - 90 + 'px', overflowX: 'hidden'}}>
