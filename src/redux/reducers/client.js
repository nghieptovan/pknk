...
const initState = {
  ...
  addStatus: 0,
  getStatus: 0,
  importInstagramStatus: 0,
  getInstagramStatus: 0
}
...
export default function client(state = initState, action) {
  ...
  return {
    ...
    case types.CHANGE_SUBSCRIPTION_STATUS:
    return {
      ...state,
      changeStatus: 1,
      changedInfo: null,
    ...
    case types.CHANGE_SUBSCRIPTION_STATUS_SUCCESS:
      return {
        ...state,
        changeStatus: 2,
        changedInfo: action.result,
    ...
    case types.CHANGE_SUBSCRIPTION_STATUS_FAIL:
      return {
        ...state,
        changeStatus: 3,
        changedInfo: null,
    ...
    case types.GET_INSTAGRAM_MEDIA:
    return {
      ...state,
      getInstagramStatus: 1,
      mediaList: null,
      getInstagramError: null,
      loadingInstagram: 1
    }
    case types.GET_INSTAGRAM_MEDIA_SUCCESS:
    return {
      ...state,
      getInstagramStatus: 2,
      mediaList: action.result,
      getInstagramError: null,
      loadingInstagram: 2
    }
    case types.GET_INSTAGRAM_MEDIA_FAIL:
    return {
      ...state,
      getInstagramStatus: 3,
      mediaList: null,
      getInstagramError: action.error,
      loadingInstagram: 3
    }
    case types.IMPORT_INSTAGRAM_MEDIA:
    return {
      ...state,
      importInstagramStatus: 1,
      mediaList: null,
      importInstagramError: null
    }
    case types.IMPORT_INSTAGRAM_MEDIA_SUCCESS:
      return {
        ...state,
        importInstagramStatus: 2,
        mediaList: action.result,
        importInstagramError: null
    }
    case types.IMPORT_INSTAGRAM_MEDIA_FAIL:
      return {
        ...state,
        importInstagramStatus: 3,
        mediaList: null,
        importInstagramError: action.error
    }
    case types.GET_CLIENT_HASHTAGS:
    return {
      ...state,
      getStatus: 1,
      hashtags: null,
    ...
    case types.GET_CLIENT_HASHTAGS_SUCCESS:
      return {
        ...state,
        getStatus: 2,
        hashtags: action.result,
        hashtagsError: null,
        loadingHashtags: 2
    }
    case types.GET_CLIENT_HASHTAGS_FAIL:
      return {
        ...state,
        getStatus: 3,
        hashtags: null,
        hashtagsError: action.error,
        loadingHashtags: 3
    }
    case types.ADD_CLIENT_HASHTAGS:
    return {
      ...state,
      addStatus: 1,
      hashtags: null,
    ...
    case types.ADD_CLIENT_HASHTAGS_SUCCESS:
      return {
        ...state,
        addStatus: 2,
        hashtags: action.result,
    ...
    case types.ADD_CLIENT_HASHTAGS_FAIL:
      return {
        ...state,
        addStatus: 3,
        hashtags: null,
    ...
    case types.EXPORT_USERNAME_SUCCESS:
      return {
        ...state,
        exportStatus: 2,
        exportResult: action.result,
    ...
    case types.EXPORT_USERNAME_FAIL:
      return {
        ...state,
        exportStatus: 3,
        exportResult: null,
